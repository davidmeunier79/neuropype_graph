...
from neuropype_graph.utils_net import read_lol_file,compute_modular_network

def visu_graph_modules_roles(net_file, lol_file, coords_file, labels_file,node_roles_file,modality_type = "",inter_modules = True):
