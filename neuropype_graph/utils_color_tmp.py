...
def generate_new_igraph_colors(nb_colors):
    ...
    new_igraph_colors = [frac_tohex_tuple(RGB_tuples[int(float(val)/nb_colors*N)]) for val in range(nb_colors)]
